...
fun AzureSettingsDialog(show: Boolean, onDismiss: () -> Unit, onSaved: (() -> Unit)? = null) {
    ...
    if (configRepo == null) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.speech_settings_title)) },
            text = { Text(stringResource(R.string.speech_settings_config_unavailable)) },
            confirmButton = {
    ...
    AlertDialog(
        ...
        text = {
            if (loading) {
                ...
                Column {
                    // TTS Toggle
                    Text(stringResource(R.string.ui_settings_tts_engine_group), style = MaterialTheme.typography.titleSmall)
                    ...
                    Row(
                        ...
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.ui_settings_azure_tts)) },
                            modifier = Modifier.weight(1f)
                        )
                        FilterChip(
                            selected = ttsEngine == TtsEngine.SYSTEM,
                            onClick = { ttsEngine = TtsEngine.SYSTEM },
                            label = { Text(stringResource(R.string.ui_settings_system_tts)) },
                            modifier = Modifier.weight(1f)
                        )
                    }
                    ...
                    Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Column {
                            Text(stringResource(R.string.ui_settings_feature_reporting_title))
                            Text(
                    ...
                    Text(
                        stringResource(R.string.ui_settings_scaling),
                    ...
                    Column(modifier = Modifier.padding(bottom = 12.dp)) {
                        Row(
                            ...
                            Text(stringResource(R.string.ui_settings_font_size), style = MaterialTheme.typography.bodyMedium)
                    ...
                    Column(modifier = Modifier.padding(bottom = 12.dp)) {
                        Row(
                            ...
                            Text(stringResource(R.string.ui_settings_playback_icons), style = MaterialTheme.typography.bodyMedium)
                    ...
                    Column(modifier = Modifier.padding(bottom = 12.dp)) {
                        Row(
                            ...
                            Text(stringResource(R.string.ui_settings_category_chips), style = MaterialTheme.typography.bodyMedium)
                    ...
                    Column(modifier = Modifier.padding(bottom = 12.dp)) {
                        Row(
                            ...
                            Text(stringResource(R.string.ui_settings_buttons), style = MaterialTheme.typography.bodyMedium)
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Row(
                            ...
                            Text(stringResource(R.string.ui_settings_input_fields), style = MaterialTheme.typography.bodyMedium)
