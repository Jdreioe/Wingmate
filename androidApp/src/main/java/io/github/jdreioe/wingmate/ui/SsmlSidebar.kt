...
fun SsmlSidebar(
    ...
    Surface(modifier = modifier.padding(8.dp), tonalElevation = 1.dp, shape = MaterialTheme.shapes.large) {
        Column(
            ...
            Text(
                stringResource(R.string.ssml_speech_controls),
            ...
            ElevatedCard(
                ...
                Column(modifier = Modifier.padding(12.dp)) {
                    ...
                    Text(
                        text = stringResource(R.string.ssml_voice, selectedVoice?.displayName ?: selectedVoice?.name ?: stringResource(R.string.ssml_no_voice)),
            ...
            ElevatedCard(
                ...
                Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.ssml_tone_speed), style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.SemiBold)
                    
                    // Pitch
                    Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                        Text(stringResource(R.string.ssml_pitch), style = MaterialTheme.typography.bodySmall, modifier = Modifier.width(48.dp))
                        Slider(
                            value = pitch.toFloat(), 
                    ...
                    // Rate
                    Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                        Text(stringResource(R.string.ssml_speed), style = MaterialTheme.typography.bodySmall, modifier = Modifier.width(48.dp))
                        Slider(
                            value = rate.toFloat(), 
                    ...
                    FilledTonalButton(
                        ...
                        Text(stringResource(R.string.ssml_apply_settings))
                    }
                }
            }
            ...
            ElevatedCard(
                ...
                Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.ssml_add_pause), style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.SemiBold)
            ...
            ElevatedCard(
                ...
                Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.ssml_emphasis), style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.SemiBold)
                    Text(stringResource(if (hasSelection) R.string.ssml_emphasis_selected else R.string.ssml_emphasis_next), style = MaterialTheme.typography.bodySmall)
                        ...
                        listOf("reduced", "moderate", "strong").forEach { level ->
                            FilterChip(
                                ...
                                label = { Text(stringResource(when (level) {
                                    "reduced" -> R.string.ssml_emphasis_reduced
                                    "moderate" -> R.string.ssml_emphasis_moderate
                                    else -> R.string.ssml_emphasis_strong
                                })) }
                            )
                        }
                    }
            ...
            ElevatedCard(
                ...
                Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.ssml_read_as), style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.SemiBold)
                    ...
                    OutlinedButton(
                        ...
                        Text(stringResource(when (sayAsType) {
                            "characters", "spell-out" -> R.string.ssml_type_spell_out
                            "date" -> R.string.ssml_type_date
                            "time" -> R.string.ssml_type_time
                            "telephone" -> R.string.ssml_type_telephone
                            "currency" -> R.string.ssml_type_currency
                            else -> R.string.ssml_type_number
                        }))
                             ...
                             listOf("spell-out", "date", "time", "telephone", "currency", "number").forEach { type ->
                                DropdownMenuItem(
                                    text = { Text(stringResource(when (type) {
                                        "spell-out" -> R.string.ssml_type_spell_out
                                        "date" -> R.string.ssml_type_date
                                        "time" -> R.string.ssml_type_time
                                        "telephone" -> R.string.ssml_type_telephone
                                        "currency" -> R.string.ssml_type_currency
            ...
            Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                ...
                Text(
                    stringResource(R.string.ssml_azure_tip),
