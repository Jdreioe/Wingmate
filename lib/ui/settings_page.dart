...
import 'package:wingmate/dialogs/customize_look_dialog.dart';
import 'package:wingmate/dialogs/theme_selection_dialog.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void _loadCurrentSettings() async {
    ...
    var settings = await widget.uiSettingsDao.getByName('default');
    if (settings == null) {
      settings = UiSettings(
        name: 'default',
    ...
    return ListTile(
      ...
      onTap: () async {
        ...
        if (newThemeMode != null) {
          setState(() {
            _currentSettings!.themeMode = newThemeMode;
          });
        }
      },
    );
    ...
    return ListTile(
      ...
      onTap: () {
        showProfileDialog(
          ...
          _currentSettings!,
          (endpoint, key, uiSettings) => widget.onSaveSettings(endpoint, key, uiSettings),
        );
      },
    );
  }
  ...
  void _revertToDefaults() async {
    ...
    await widget.uiSettingsDao.deleteByName('default');
  ...
  void _saveSettings() async {
    if (_currentSettings != null) {
      await widget.uiSettingsDao.update(_currentSettings!);
      widget.onSettingsSaved(_currentSettings!);
      ScaffoldMessenger.of(context).showSnackBar(
