...
- **Screens and Pages**: Visual vocabulary, symbols, personal images, recordings, sounds, and layout choices.
...
- **Backups**: Backup archives are created only when you request one and are saved or shared through a location you choose. They are not encrypted and may contain private communication data.
...
Wingmate includes optional, **opt-in** feature usage reporting on Android using Aptabase.
